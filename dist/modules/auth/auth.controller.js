...
router.patch("/resend-otp", (0, middleware_1.validation)(validators.resendOtp), async (req, res, next) => {
    await auth_service_1.default.resendOtp(req.body);
    return (0, response_1.successResponse)({ res });
});
router.post("/signup-gmail", async (req, res, next) => {
    const { idToken } = req.body;
    const data = await auth_service_1.default.signUpWithGmail(idToken);
